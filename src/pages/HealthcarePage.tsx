        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/12 ios-glass-card p-2">
                <img
              ...
              <div className="space-y-4">
                {SERVICES_INCLUDE.healthcare.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3.5 p-4 rounded-2xl ios-glass border border-white/15 ">
                    <div className="w-6 h-6 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#007AFF] shrink-0 mt-0.5 ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 flex justify-center">
              <div className="ios-glass-card p-4 sm:p-6 rounded-3xl shadow-xl border border-white/12 max-w-md w-full">
                <img
            ...
            <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 rounded-3xl ios-glass-card shadow-xs">
                ...
                <h4 className="font-bold text-white text-base mb-1">Pharmaceuticals</h4>
              ...
              <div className="p-5 rounded-3xl ios-glass-card shadow-xs">
                ...
                <h4 className="font-bold text-white text-base mb-1">Providers</h4>
                <p className="text-slate-300 text-xs leading-relaxed">
              ...
              <div className="p-5 rounded-3xl ios-glass-card shadow-xs">
                ...
                <h4 className="font-bold text-white text-base mb-1">Payers</h4>
                <p className="text-slate-300 text-xs leading-relaxed">
              ...
              <div className="p-5 rounded-3xl ios-glass-card shadow-xs">
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-100 block mb-1">Pillar 4</span>
                <h4 className="font-bold text-white text-base mb-1">Policymakers</h4>
                <p className="text-slate-300 text-xs leading-relaxed">
